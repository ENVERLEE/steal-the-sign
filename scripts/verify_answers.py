...
- 창작: 문제은행 verify(skill·standard·unique)를 다시 실행해 정답과 맞춘다.
"""
from __future__ import annotations

from scripts.check_book import day_refs
from scripts.common import Context, Log, has_choices, is_created_id
...
def run(ctx: Context) -> Log:
    ...
    checked = {"past": 0, "created": 0, "shortcut": 0}
    done = set()
